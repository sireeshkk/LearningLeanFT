...
public class LearnApplicationModels extends AppModelBase {		private SPEAKERSLink SPEAKERSLink;
	...
	{
		setName("LearnApplicationModels");
				SPEAKERSLink = new SPEAKERSLink(contextTestObject, this);
		BuyNow = new BuyNow(contextTestObject, this);
		...
		public BuyNow BuyNow() { return BuyNow; }
	...
	public class BuyNow extends ButtonNodeBase
	{

		
								public BuyNow(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);
		...
		protected com.hp.lft.sdk.web.ButtonDescription createDescription() throws GeneralLeanFtException{
			...
			try{
				description = new com.hp.lft.sdk.web.ButtonDescription.Builder().buttonType("submit").name("BUY NOW").tagName("BUTTON").build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
	...
	public class REMOVEWebElement extends WebElementNodeBase
	{
		...
		protected com.hp.lft.sdk.web.WebElementDescription createDescription() throws GeneralLeanFtException{
			...
			try{
				description = new com.hp.lft.sdk.web.WebElementDescription.Builder().innerText(new RegExpProperty("REM.*")).tagName("A").build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
	...
	public class HOMELink extends LinkNodeBase
	{
		...
		protected com.hp.lft.sdk.web.LinkDescription createDescription() throws GeneralLeanFtException{
			com.hp.lft.sdk.web.LinkDescription description = null; 
			try{
				description = new com.hp.lft.sdk.web.LinkDescription.Builder().innerText("HOME").tagName("A").build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
